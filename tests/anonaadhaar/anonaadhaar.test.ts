...
async function prepareTestData() {
  ...
  const updateTemplate = [
    ...
    '0', // credentialStatus.revocationNonce
    '2789441998411353097504888849796647342929687866714787904727157138859134659534',
    '5031591587830552372449607231505511649306267626852607045693212054932440156856', // credentialSubject.addresses
    '11896622783611378286548274235251973588039499084629981048616800443645803129554',
...
describe('AadhaarVerifier', function () {
  ...
  "credentialSchema": {
    ...
    */
    ...
    // hashIndex
    assert(
      witness[3] === 6379451293312839020808366454431069631969872741262486213078194426113271531457n,
      `HashIndex mismatch: ${witness[3]} != 6379451293312839020808366454431069631969872741262486213078194426113271531457`
    );
    // hashValue
    assert(
